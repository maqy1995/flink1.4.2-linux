...
public class AccumulatorLiveITCase extends TestLogger {
	...
	private static class BatchPlanExtractor extends LocalEnvironment {
		...
		public JobExecutionResult execute(String jobName) throws Exception {
			System.out.println("maqy AccumulatorLivelTCase 流处理  中的execute(String jobName)方法");
			System.out.println("maqy AccumulatorLivelTCase 批处理  中的execute(String jobName)方法");
