...
public class SocketWindowWordCount {
	...
	public static void main(String[] args) throws Exception {
		...
		windowCounts = text
			...
			.trigger(PurgingTrigger.of(new Trigger<WordWithCount, GlobalWindow>() {
				@Override
				public TriggerResult onElement(WordWithCount element, long timestamp, GlobalWindow window, TriggerContext ctx) throws Exception {
					...
					if (element.word.equals("ma")) {
						System.out.println("onElement Fire");
				...
				public TriggerResult onProcessingTime(long time, GlobalWindow window, TriggerContext ctx) throws Exception {
					...
					if ((time - nowTime) > 1000) {
						System.out.println("time:" + time + "     " + "noewTime" + nowTime);
						return TriggerResult.FIRE;
					} else {
						return TriggerResult.CONTINUE;
					}
